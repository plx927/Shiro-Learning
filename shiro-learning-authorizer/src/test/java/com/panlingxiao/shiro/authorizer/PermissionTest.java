...
public class PermissionTest extends BaseTest {
    ...
    /**
     * 通过system:user:update,delete来验证system:user:update,system:user:delete是可以的，但是反之则不行
     * 测试单个资源多个操作
     */
    @Test
    public void testPermission(){
        ...
        org.junit.Assert.assertFalse(subject().isPermitted("system:user:delete,update"));
    }
    ...
    public void testPermission3(){
        ...
        org.junit.Assert.assertTrue(subject().isPermitted("product:view"));
        org.junit.Assert.assertFalse(subject().isPermitted("user:system:view"));
    }
